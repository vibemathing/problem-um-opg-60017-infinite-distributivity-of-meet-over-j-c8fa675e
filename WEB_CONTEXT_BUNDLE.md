...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60017"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-v1",
      "problem_contract_sha256": "0c093da4c4c3223efdeea0ffb00cccedb4bb8e3f5e5233f5d4b99a4927ace964",
      "problem_id": "problem:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e",
      "route_id": "route:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-source-fidelity-01",
      "graph_id": "graph:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture $f \\sqcap \\bigsqcup S = \\bigsqcup \\langle f \\sqcap \\rangle^{\\ast} S$ for principal funcoid $f$ and a set $S$ of funcoids of appropriate sources and destinations."
          },
          "statement_sha256": "449a874d66b20eab6eb87a86bcf497605e022871e6a01237a4513b079a1dd15b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-root",
      "route_id": "route:um-opg-60017-infinite-distributivity-of-meet-over-j-c8fa675e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60017-b8521bcbdada",
        "url": "https://www.unsolvedmath.com/problems/OPG-60017"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
